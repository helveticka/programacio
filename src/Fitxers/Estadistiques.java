...
public class Estadistiques {
    ...
    public void escriureInici() throws Exception {
        Linia l = new Linia();
        estadistiquesLinia = new FitxerLiniaEscriptura("estadistiques.txt", true);
    ...
    public void escriureResposta(Paraula resposta) throws Exception {
        estadistiquesParaula = new FitxerParaulaEscriptura("estadistiques.txt", true);
    ...
    public void veureEstadistiques() throws Exception {
        estadistiquesLectura = new FitxerLiniaLectura("estadistiques.txt");
